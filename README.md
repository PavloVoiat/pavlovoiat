...
My passion is IT and game development, and I follow a unique approach: **100% Mobile Development.**
...
## 🛠 My Unusual Setup
I don't own a PC, so I create projects directly on my **Xiaomi Pad 5**:
- **Coding:** Acode (Android IDE)
- **Gamedev:** Godot 4 (Mobile version)
- **3D Modeling:** Blender 4.5 LTS (via emulator) + Sketchfab
- **Devices:** Xiaomi Pad 5 + Smart Pen 2nd Gen + Poco X6 Pro / Poco F3
