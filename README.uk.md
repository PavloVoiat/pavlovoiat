...
Я Full-stack розробник з України 🇺🇦, зараз живу в Німеччині 🇩🇪.
Моя пристрасть — IT та розробка ігор, і я дотримуюсь унікального підходу: **100% Mobile Development.**
...
## 🛠 Мій незвичайний сетал
У мене немає ПК, тому я створюю проєкти прямо на своєму **Xiaomi Pad 5**:
- **Кодинг:** Acode (Android IDE)
- **Gamedev:** Godot 4 (Mobile версія)
- **3D Моделювання:** Blender 4.5 LTS (через емулятор) + Sketchfab
- **Девайси:** Xiaomi Pad 5 + Smart Pen 2nd Gen + Poco X6 Pro / Poco F3

## 🏗 Поточний проєкт
Зараз я працюю над **мобільною грою про свій район** на Godot 4. Це проєкт, що поєднує GDScript та кастомне моделювання в Blender.
...
---
>*«Якщо не можна обійтися без ПК — я використовую емулятор або онлайн-інструменти. Немає перешкод для того, хто любить IT!»*
