...
# Привіт, я Павло! 👋 (Українська)

Я **Full-stack розробник** з України 🇺🇦, наразі живу в Німеччині 🇩🇪.  
Моя пристрасть — це IT та розробка ігор. Я починав свій шлях, маючи лише планшет, а тепер перейшов на ноутбук.
...
## 🛠 Мій робочий простір (Setup)

Довгий час я працював виключно на планшеті, але тепер у мене з'явився **ноутбук**:

| Пристрій | Характеристики / Інструменти |
|----------|------------------------------|
| **Ноутбук** | **Huawei Matebook D15 (2020)** <br> • AMD Ryzen 7 3700U <br> • 8 GB RAM <br> • 512 SSD |
| **Планшет** | **Xiaomi Pad 5** зі стилусом Xiaomi Smart Pen 2 Gen — для скетчів, ідей та кодингу в дорозі <br> • Acode (Android IDE) <br> • Godot 4 (Мобільна версія) |
| **Телефони**| Poco X6 Pro (Основний), Poco F3 — для тестування мобільних застосунків | 

## 🏗 Поточний проєкт

Зараз я працюю над **мобільною грою про свій район** на рушії Godot 4. Цей проєкт поєднує GDScript та створення власних моделей у Blender.
...
>*"Якщо без ПК не обійтися, я використовую емулятор або онлайн-інструменти. Для тих, хто любить IT, перешкод не існує!"*