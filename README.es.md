...
[![es](https://img.shields.io/badge/🇪🇸_Español-gold?style=for-the-badge)](README.es.md)
...
# ¡Hola, soy Pavlo! 👋 (Español)

Soy un **Desarrollador Full-stack** de Ucrania 🇺🇦, actualmente viviendo en Alemania 🇩🇪.  
Mi pasión es la informática y el desarrollo de videojuegos. Empecé mi camino usando solo una tableta, y ahora he dado el salto a una laptop.
...
## 🛠 Mi Entorno de Trabajo (Setup)

Durante mucho tiempo trabajé exclusivamente en una tableta, pero ahora tengo una **laptop**:

| Dispositivo | Especificaciones / Herramientas |
|-------------|---------------------------------|
| **Laptop** | **Huawei Matebook D15 (2020)** <br> • AMD Ryzen 7 3700U <br> • 8 GB RAM <br> • 512 SSD |
| **Tableta** | **Xiaomi Pad 5**, con Xiaomi Smart Pen 2 Gen - para bocetos, ideas y programar sobre la marcha <br> • Acode (Android IDE) <br> • Godot 4 (Versión móvil) |
| **Teléfonos**| Poco X6 Pro (Principal), Poco F3 - para pruebas de aplicaciones móviles | 

## 🏗 Proyecto Actual

Actualmente estoy trabajando en un **videojuego móvil sobre mi barrio** en Godot 4. Este proyecto combina GDScript y modelado propio en Blender.
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=flat-square&logo=data:image/svg+xml;base64,)](https://www.linkedin.com/in/pavlovoiat)
...
>*"Si no hay más remedio que usar una PC, recurro a un emulador o a herramientas en línea. ¡No hay barreras para quienes aman la informática!"*