...
Soy desarrollador Full-stack de Ucrania 🇺🇦, actualmente vivo en Alemania 🇩🇪.
Mi pasión es la TI y el desarrollo de juegos, y sigo un enfoque único: **100% Desarrollo Móvil.**
...
## 🛠 Mi Configuración Inusual
No tengo PC, así que creo proyectos directamente en mi **Xiaomi Pad 5**:
- **Codificación:** Acode (IDE para Android)
- **Gamedev:** Godot 4 (versión móvil)
- **Modelado 3D:** Blender 4.5 LTS (mediante emulador) + Sketchfab
- **Dispositivos:** Xiaomi Pad 5 + Smart Pen 2nd Gen + Poco X6 Pro / Poco F3

## 🏗 Proyecto Actual
Actualmente estoy trabajando en un **juego móvil sobre mi barrio** en Godot 4. Este proyecto combina GDScript y modelado personalizado en Blender.
...
---
>*"Si no puedes prescindir de una PC, uso un emulador o herramientas en línea. ¡No hay barreras para quienes aman la TI!"*
